...
//两次插补间隔时间
#define TRAIL_REVISE_TIME 0.064f // 单位 s 插补函数执行一个周期的时间

#define TEST_PATH_NUMBER 8 //测试路径的条数

#define MAX_PLAN_VEL 3.00f //最大直线速度 2
#define MAX_PLAN_W 0.20f   //最大角速度(旋转速度) 2

#define ACC 1.5f		 //直线段加速度m/s^2 1.5
#define W_ACC 0.02f		 //自传段角加速度 5.0
...
#define X_Y_Error_0 0.4f  //允许误差值
#define Theta_Error_0 0.6 //8 * PI / 180 //允许误差值

/***************** 终点使用的精度范围 *****************/

#define X_Y_Error_1 0.01f	//允许误差值
#define Theta_Error_1 0.001 //1 * PI / 180 //允许误差值
